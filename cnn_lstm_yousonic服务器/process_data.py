...
class saveSameVoice(Dataset):
    ...
    def ergodic_data(self):
        ...
        torch.save(same_voice_data,"same_voice_data_full.pt")
        print("finished save")
...
transformed_dataset = saveSameVoice(csv_file='/data2/queenie/IEEE2015Ace/solution/DatasetProcessing/full.csv',
