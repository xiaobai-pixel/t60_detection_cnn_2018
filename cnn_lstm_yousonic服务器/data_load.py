...
class FacialKeypointsDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        numpy_image =  os.path.join(self.audio_image_dir,
                                    self.key_pts_frame.iloc[idx, 0].split("/")[-2] ,self.key_pts_frame.iloc[idx, 0].split("/")[-1])
        ...
        # print("key_pts:", self.key_pts_frame.iloc[idx, 1:])
       ...
       # print("numpy image:", numpy_image, "ddr:", DDR_each_band, "t60:", T60_each_band)
        ...
        # print("type of DDR_each_band:",type(DDR_each_band))
